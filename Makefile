...
OBJ = ft_atoi.o ft_split.o main.o ft_substr.o ft_strlen.o ft_lstadd_back.o ft_lstnew.o \
	...
	ft_strncmp.o sort_utils.o ft_printf.o ft_putaddress.o ft_putchar.o ft_putnbr.o ft_putstr.o ft_putunbr_base.o sort_extra.o
CFLAGS = -Wall -Wextra -Werror

BONUS_OBJ = ./bonus/get_next_line_bonus.o ./bonus/checker_bonus.o ./bonus/ft_strncmp_bonus.o ./bonus/ft_atoi_bonus.o ./bonus/ft_split_bonus.o ./bonus/ft_substr_bonus.o ./bonus/ft_strlen_bonus.o ./bonus/ft_lstadd_back_bonus.o ./bonus/ft_lstnew_bonus.o \
